...
func TestNormalizeProtocol(t *testing.T) {
	tests := []struct {
		...
		{"canonical anthropic-vertex is idempotent", ProtocolAnthropicVertex, ProtocolAnthropicVertex},
		{"anthropic-vertex case-insensitive", "ANTHROPIC-VERTEX", ProtocolAnthropicVertex},
	}
...
func TestValidateProtocol(t *testing.T) {
	tests := []struct {
		...
		{"anthropic-vertex ok", ProtocolAnthropicVertex, false, ""},
...
func TestValidateProtocol_ErrorMessageListsAllProtocols(t *testing.T) {
	...
	for _, sub := range []string{ProtocolAnthropic, ProtocolOpenAIChatCompletions, ProtocolOpenAIResponses, ProtocolAnthropicBedrock, ProtocolAnthropicVertex} {
