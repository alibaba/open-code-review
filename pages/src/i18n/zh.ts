...
export const zh: TranslationKeys = {
  ...
  'docs.configTipZaiDesc': '如果你订阅了智谱 GLM Coding Plan（编程套餐），必须将请求路由到专属的 coding 端点，才会走套餐额度。默认的 z-ai 预设指向通用按量端点，会导致套餐密钥静默扣钱包余额并报「余额不足」（1113）错误。',
  'docs.configTipZaiLabel': '切换到 Coding 端点',
  'docs.configTipZaiNote': 'API Key 仍使用 Z_AI_API_KEY（同一把密钥两个端点都可用）；模型推荐 glm-5.2 或 glm-4.7。',
