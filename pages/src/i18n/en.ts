...
export const en: TranslationKeys = {
  ...
  'docs.configTipZaiTitle': 'Z.AI / Zhipu GLM Coding Plan',
  'docs.configTipZaiDesc': 'If you subscribe to the Z.AI (Zhipu) GLM Coding Plan, requests must go through the dedicated coding endpoint to bill against your plan quota. The default z-ai preset points to the generic pay-as-you-go endpoint, which silently drains your wallet balance and raises a spurious "insufficient balance" (1113) error.',
  'docs.configTipZaiLabel': 'Switch to the Coding endpoint',
  'docs.configTipZaiNote': 'The API key is still Z_AI_API_KEY (the same key works on both endpoints). Recommended models: glm-5.2 or glm-4.7.',
