...
export const ja: TranslationKeys = {
  ...
  'docs.configTipZaiTitle': 'Z.AI / 智谱 GLM Coding Plan',
  'docs.configTipZaiDesc': 'Z.AI（智谱）の GLM Coding Plan をご契約の場合、リクエストは専用の coding エンドポイント経由にする必要があります。デフォルトの z-ai プリセットは従量課金の汎用エンドポイントを指すため、プランの API キーがサイレントにウォレット残高を消化し、誤った「残高不足」(1113) エラーになります。',
  'docs.configTipZaiLabel': 'Coding エンドポイントに切替',
  'docs.configTipZaiNote': 'API キーは引き続き Z_AI_API_KEY を使用（同じキーで両エンドポイントに認証可能）。推奨モデル：glm-5.2 または glm-4.7。',
