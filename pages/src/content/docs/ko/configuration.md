...
두 방법 모두 동일한 `language` 설정을 구성합니다. GitHub Actions에서는 전용
입력 `language: Chinese`를 사용하고, GitLab CI, Bitbucket Pipelines, CodeUp CI,
Gerrit CI, GitFlic CI에서는 `OCR_LANGUAGE=Chinese`를 사용합니다.
