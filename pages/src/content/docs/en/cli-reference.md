...
| `--max-tokens-budget <n>` | — | `0` (unlimited) | Cap total input + output token usage for the review. Checked before each LLM round and at dispatch; over-budget subtasks stop and partial results are still published. |
