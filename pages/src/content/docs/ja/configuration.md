...
どちらも同じ `language` 設定を構成します。GitHub Actions では専用入力
`language: Chinese` を使用し、GitLab CI、Bitbucket Pipelines、CodeUp CI、
Gerrit CI、GitFlic CI では `OCR_LANGUAGE=Chinese` を使用します。
