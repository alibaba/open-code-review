...
const messages: Record<SupportedLocale, Record<string, string>> = {
  en: {
    ...
    'view.config.reasoningEffort': 'Reasoning effort',
    'view.config.reasoningEffortHint': 'Saved for this model. Supported values depend on the model.',
    'view.config.providerDefault': 'Provider default',
  ...
  'zh-cn': {
    ...
    'view.config.reasoningEffort': '推理强度',
    'view.config.reasoningEffortHint': '按模型保存；具体支持的取值由模型决定。',
    'view.config.providerDefault': 'Provider 默认值',
