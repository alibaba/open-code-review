...
| `OCR_LANGUAGE` | No | No | Review output language (e.g. `English`, `Chinese`). OCR resolves it as the `language` setting; the example also preserves its compatibility shell step. |
