...
func TestEmitRunResult_JSONNoFiles(t *testing.T) {
	...
	got := captureStdout(t, func() {
		err := emitRunResult(context.Background(), ag, nil, time.Now(), "json", "developer", nil, identity, os.Stdout)
		if err != nil {
...
func TestEmitRunResult_JSONLLMIdentityNamedProvider(t *testing.T) {
	...
	identity := &jsonLLMIdentity{Provider: "anthropic", Model: "claude-opus-4-6"}
	got := captureStdout(t, func() {
		if err := emitRunResult(context.Background(), ag, nil, time.Now(), "json", "developer", nil, identity, os.Stdout); err != nil {
...
func TestEmitRunResult_JSONUsesManifestTerminalState(t *testing.T) {
	...
	got := captureStdout(t, func() {
		if err := emitRunResult(context.Background(), ag, nil, time.Now(), "json", "developer", nil, nil, os.Stdout); err != nil {
			t.Fatalf("emitRunResult: %v", err)
		}
	})
	var out jsonOutput
...
func TestEmitRunResult_JSONWithComments(t *testing.T) {
	...
	got := captureStdout(t, func() {
		err := emitRunResult(context.Background(), ag, comments, time.Now(), "json", "developer", nil, nil, os.Stdout)
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
	})
...
func TestEmitRunResult_TextNoComments(t *testing.T) {
	...
	got := captureStdout(t, func() {
		err := emitRunResult(context.Background(), ag, nil, time.Now(), "text", "developer", nil, nil, os.Stdout)
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
	})
...
func TestEmitRunResult_TextPartialNeverLooksGood(t *testing.T) {
	...
	got := captureStdout(t, func() {
		if err := emitRunResult(context.Background(), ag, nil, time.Now(), "text", "developer", nil, nil, os.Stdout); err != nil {
			t.Fatalf("emitRunResult: %v", err)
		}
	})
...
func TestEmitRunResult_TextCompleteReportsFindingsAndWaived(t *testing.T) {
	...
	got := captureStdout(t, func() {
		if err := emitRunResult(context.Background(), ag, comments, time.Now(), "text", "developer", nil, nil, os.Stdout); err != nil {
			t.Fatalf("emitRunResult: %v", err)
		}
	})
...
func TestEmitRunResult_TextWithComments(t *testing.T) {
	...
	got := captureStdout(t, func() {
		err := emitRunResult(context.Background(), ag, comments, time.Now(), "text", "developer", nil, nil, os.Stdout)
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
	})
...
func TestEmitRunResult_AgentTextRestoresQuiet(t *testing.T) {
	...
	got := captureStdout(t, func() {
		err := emitRunResult(context.Background(), ag, nil, time.Now(), "text", "agent", q, nil, os.Stdout)
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
	})
...
func TestEmitRunResult_AgentJSONDoesNotRestore(t *testing.T) {
	...
	got := captureStdout(t, func() {
		err := emitRunResult(context.Background(), ag, nil, time.Now(), "json", "agent", q, nil, os.Stdout)
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
	})
...
func TestEmitRunResult_NilQuietHandle(t *testing.T) {
	ag := &mockResultProvider{filesReviewed: 1}
	got := captureStdout(t, func() {
		err := emitRunResult(context.Background(), ag, nil, time.Now(), "text", "agent", nil, nil, os.Stdout)
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
	})
...
func TestEmitRunResult_JSONTraceIDFromContext(t *testing.T) {
	...
	got := captureStdout(t, func() {
		err := emitRunResult(ctx, ag, nil, time.Now(), "json", "developer", nil, nil, os.Stdout)
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
	})
