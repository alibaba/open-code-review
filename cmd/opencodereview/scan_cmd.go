...
type scanOptions struct {
	...
	provider        string // --provider: override resolved LLM provider for this scan
...
func parseScanFlags(args []string) (scanOptions, error) {
	...
	a.StringVar(&opts.provider, "provider", "", "override LLM provider for this scan (e.g., openai)")
...
Flags:
  ...
  --provider string       override LLM provider for this scan (e.g., openai)
