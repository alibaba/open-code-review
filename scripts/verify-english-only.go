...
var allowedPrefixes = []struct{ prefix, reason string }{
	...
	{"lessons/", "Chinese learning lessons for the local engineering knowledge base"},
	{"reference/", "Chinese architecture reference for the local engineering knowledge base"},
}
